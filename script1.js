(function () {
    ...
    function renderCPU() {
        ...
        const ids = ["cpuBrand", "cpuFamily", "cpuModel", "cpuStatus", "cpuNotes"];
        restoreSection("cpu", ids);
        bindSection("cpu", ids);
        initCpuCascade();
    }

    function initCpuCascade() {
        const brandEl = $("cpuBrand");
        const familyEl = $("cpuFamily");
        const modelEl = $("cpuModel");
    ...
    function initApp() {
        ...
        const caseItem = document.querySelector('.sidebar li[data-page="case"]');
        if (caseItem) {
            caseItem.dataset.page = "pcCase";
        }
